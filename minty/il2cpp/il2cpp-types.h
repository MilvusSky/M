...
//namespace {
    ...
    struct __declspec(align(8)) BaseEntity__Fields {
        ...
        EntityType__Enum_1 et12;
        struct Action_2_BaseEntity_Boolean_* onSetActiveCallback;
        EntityType__Enum_1 et13;
        EntityType__Enum_1 et14;
        ...
        EntityType__Enum_1 et17;
        EntityType__Enum_1 et18;
        ...
        int32_t AHFEOKHDNFC1;
        int32_t KBLPJPHLOFE;
        bool isInCutscene;
        bool isDontDestroyGameObject;
        bool isDontDestroyGameObject1;
        ...
        bool _hasAddedInitialComponents1;
    ...
    enum class PropType__Enum : uint32_t {
        ...
        PROP_IS_CAN_PUT_FIVE_STAR_RELIQUARY = 0x00002743,
        PROP_IS_AUTO_LOCK_FIVE_STAR_RELIQUARY = 0x00002744
    };
